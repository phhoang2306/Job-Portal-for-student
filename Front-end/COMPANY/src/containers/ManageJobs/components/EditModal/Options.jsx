...
export const cateOptions = [
    {value: '1', label: 'IT phần mềm'},
    {value: '2', label: 'Công nghệ cao'},
    {value: '3', label: 'Công nghệ thông tin'}, 
    {value: '4', label: 'Việc làm IT'},
    {value: '5', label: 'IT Phần cứng / Mạng'} ,
    {value: '6', label: 'Thiết kế đồ họa'},
    {value: '7', label: 'Điện tử viễn thông'},
    {value: '8', label: 'Ngân hàng / Tài chính'},
    {value: '9', label: 'Bưu chính - Viễn thông'},
    {value: '10', label: 'Giáo dục / Đào tạo'},
    {value: '11', label: 'Ngành nghề khác'},
    {value: '12', label: 'Kinh doanh / Bán hàng'},
    {value: '13', label: 'Hoạch định/Dự án'},
    {value: '14', label: 'Công nghệ Ô tô'},
    {value: '15', label: 'Bán lẻ / bán sỉ'},
    {value: '16', label: 'Hành chính / Văn phòng'},
    {value: '17', label: 'Kế toán / Kiểm toán'},
    {value: '18', label: 'Nhân sự'},
    {value: '19', label: 'Báo chí / Truyền hình'},
    {value: '20', label: 'Y tế / Dược'},
    {value: '21', label: 'Điện / Điện tử / Điện lạnh'},
    {value: '22', label: 'Marketing / Truyền thông / Quảng cáo'},
    {value: '23', label: 'Quản lý chất lượng (QA/QC)'},
    {value: '24', label: 'Khách sạn / Nhà hàng'},
    {value: '25', label: 'Quản lý điều hành'},
    {value: '26', label: 'Dịch vụ khách hàng'},
    {value: '27', label: 'Cơ khí / Chế tạo / Tự động hóa'},
    {value: '28', label: 'Logistics'},
    {value: '29', label: 'Xuất nhập khẩu'},
    {value: '30', label: 'Mỹ thuật / Nghệ thuật / Điện ảnh'},
    {value: '31', label: 'Tài chính / Đầu tư'},
    {value: '32', label: 'Biên / Phiên dịch'},
    {value: '33', label: 'Chứng khoán / Vàng / Ngoại tệ'},
    {value: '34', label: 'Bán hàng kỹ thuật'},
    {value: '35', label: 'Bảo trì / Sửa chữa'},
    {value: '36', label: 'Du lịch'},
    {value: '37', label: 'Tư vấn'},
    {value: '38', label: 'Thực phẩm / Đồ uống'},
    {value: '39', label: 'Tổ chức sự kiện / Quà tặng'},
    {value: '40', label: 'Hàng gia dụng'},
    {value: '41', label: 'Thư ký / Trợ lý'},
    {value: '42', label: 'Vận tải / Kho vận'},
    {value: '43', label: 'Thiết kế nội thất'},
    {value: '44', label: 'Hà Nội'},
    {value: '45', label: 'Cầu Giấy'},
    {value: '46', label: 'Luật/Pháp lý'},
    {value: '47', label: 'Bất động sản'}, 
    {value: '48', label: 'Xây dựng'},
    {value: '49', label: 'Hồ Chí Minh'},
    {value: '50', label: 'Sản phẩm công nghiệp'},
    {value: '51', label: 'Sản xuất'},
    {value: '52', label: 'Thời trang'},
    {value: '53', label: 'Dược phẩm / Công nghệ sinh học'},
    {value: '54', label: 'Hàng không'},
    {value: '55', label: 'Bảo hiểm'},
    {value: '56', label: 'In ấn / Xuất bản'},
    {value: '57', label: 'Kiến trúc'},
    {value: '58', label: 'Mỹ phẩm / Trang sức'},
    {value: '59', label: 'NGO / Phi chính phủ / Phi lợi nhuận'},
    {value: '60', label: 'Địa chất / Khoáng sản'},
    {value: '61', label: 'Spa / Làm đẹp'},
    {value: '62', label: 'Hoá học / Sinh học'},
    {value: '63', label: 'Dệt may / Da giày'},
    {value: '64', label: 'Nông / Lâm / Ngư nghiệp'},
    {value: '65', label: 'Hàng tiêu dùng'},
    {value: '66', label: 'Dầu khí/Hóa chất'},
    {value: '67', label: 'An toàn lao động'},
    {value: '68', label: 'Hàng cao cấp'},
    {value: '69', label: 'Phi chính phủ / Phi lợi nhuận'},
    {value: '70', label: 'Môi trường / Xử lý chất thải'},
  ]